...
2. `ONBOARDING\START-HERE.md` routes the reviewed Windows bootstrap, harness installation and verification, approved Obsidian configuration restore, executable discovery, and project-data environment setup.
...
9. The future cloud rollout follows `agent-harness\ONBOARDING\CLOUD-AGENTS.md` and issue #16. Planning does not grant cloud-ready status.
