...
- The human guide is `C:\Users\dougl\.agents\human-readable\README.md`; `README.html` is its matching browser-readable mirror.
...
2. Decide whether an elevated RAMMap capture is still useful.
